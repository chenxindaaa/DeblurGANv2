...
class FPNMobileNet(nn.Module):
    ...
    def __init__(self, norm_layer, output_ch=3, num_filters=64, num_filters_fpn=128, pretrained=True):
        ...
        self.fpn = FPN(num_filters=num_filters_fpn, norm_layer = norm_layer, pretrained=False)
...
class FPN(nn.Module):
    ...
    def __init__(self, norm_layer, num_filters=128, pretrained=False):
        ...
        if pretrained:
            ...
            state_dict = torch.load('mobilenetv2.pth.tar', map_location=torch.device('cuda')) # add map_location='cpu' if no gpu
